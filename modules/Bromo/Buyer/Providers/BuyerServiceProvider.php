...
namespace Bromo\Buyer\Providers;
...
class BuyerServiceProvider extends ServiceProvider
{
    ...
    {
        $langPath = resource_path('lang/modules/buyer');

        if (is_dir($langPath)) {
            $this->loadTranslationsFrom($langPath, 'buyer');
        } else {
    ...
    {
        $viewPath = resource_path('views/modules/buyer');
