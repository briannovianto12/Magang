...
namespace Bromo\Logistic\Providers;
...
class LogisticServiceProvider extends ServiceProvider
{
    ...
    {
        $this->publishes([
            __DIR__.'/../Config/config.php' => config_path('logistic.php'),
        ], 'config');
    ...
    {
        $viewPath = resource_path('views/modules/logistic');
    ...
    {
        $langPath = resource_path('lang/modules/logistic');
