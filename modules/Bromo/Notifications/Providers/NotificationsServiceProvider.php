...
namespace Bromo\Notifications\Providers;

use Illuminate\Support\ServiceProvider;
use Illuminate\Database\Eloquent\Factory;
use Bromo\Notifications\Events\NewsNotificationByTopic;
use Bromo\Notifications\Listeners\SendNewsNotificationByTopic;
...
class NotificationsServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app['events']->listen(NewsNotificationByTopic::class, SendNewsNotificationByTopic::class);
    }
}
