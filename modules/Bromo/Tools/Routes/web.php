...
Route::prefix('tools')->group(function() {
    ...
    Route::resource('postalCodeFinder', 'PostalCodeFinderController')->except('show');
    Route::prefix('postalCodeFinder')->group(function() {
        ...
        Route::name('postalCodeFinder.getByPostalCode')->get('/postal-code', 'PostalCodeFinderController@getByPostalCode');
        Route::name('postalCodeFinder.changePostalCode')->post('/postal-code/edit', 'PostalCodeFinderController@editPostalCode');
    });
