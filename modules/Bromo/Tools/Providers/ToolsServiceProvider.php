...
namespace Bromo\Tools\Providers;
...
class ToolsServiceProvider extends ServiceProvider
{
    ...
    {
        $viewPath = resource_path('views/modules/tools');
        ...
        $this->loadViewsFrom(array_merge(array_map(function ($path) {
            return $path . '/modules/tools';
        }, \Config::get('view.paths')), [$sourcePath]), 'tools');
    }
    ...
    {
        $langPath = resource_path('lang/modules/tools');
